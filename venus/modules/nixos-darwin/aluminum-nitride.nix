...

{
  ...
  networking.hostName = "Yutos-Aluminum-Nitride"; # Define your hostname.
  ...
  users.users = {
    ...
    # Necessary for deploy-rs to be able to 1. push the config and 2. confirm activation.
    # I wrote two things above ^ because if you remove/add this config between old/new configurations, you need it
    # in both the old and new configurations for deploy-rs to be able to fully push the config without
    # having to type in the password for root.
    root = {
      openssh.authorizedKeys.keys = [
        "ssh-rsa  yuto@Yutos-MacBook-Pro.local"
      ];
